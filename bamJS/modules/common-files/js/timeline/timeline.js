...
//
//	This version by Ryan Horne, with modifications for BAM framework
            ...
            .on("brush", function() {
              ...
              /*  targetNames.forEach(function(d) {
                ...
                //change trigger from http://stackoverflow.com/questions/20992750/textbox-value-change-event-not-getting-fired-jquery
                 $("#timeStart").val(brush.extent()[0].getFullYear()).trigger('change');
                $("#timeEnd").val(brush.extent()[1].getFullYear()).trigger('change');
                           $("#timeInterval").val(Math.abs(brush.extent()[0].getFullYear() - brush.extent()[1].getFullYear()));
...
// had to place it here, as it was not working in the main php file.
