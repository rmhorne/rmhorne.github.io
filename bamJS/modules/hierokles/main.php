...
<link href='https://api.mapbox.com/mapbox.js/v3.0.1/mapbox.css' rel='stylesheet' />
    <script src="../common-files/js/leaflet-ajax/dist/leaflet.ajax.js"></script>
    <script src="../common-files/js/EasyButton/src/easy-button.js"></script>
    <link href='../common-files/js/EasyButton/src/easy-button.css' rel='stylesheet' />

    <script src="../common-files/js/easyPrint/dist/leaflet.easyPrint.js"></script>
    <link href='../common-files/js/easyPrint/dist/easyPrint.css' rel='stylesheet' />
    ...
    <body>
        ...
        <script>
            ...
            d3.json("hierokles_places.json", function(error, json) {


//using a plugin to load leaflet ajax. Nice, quick, and painless! Here as they may take a while
                ...
                var nodes = json.nodes.map(function(d) {
                    ...
                    mainTable += "</td>";
                                        //hidden x
                    mainTable += "<td>";
                    mainTable += d.attributes.x;
                    mainTable += "</td>";
                    //hidden y
                    mainTable += "<td>";
                    mainTable += d.attributes.y;
                    mainTable += "</td>";
